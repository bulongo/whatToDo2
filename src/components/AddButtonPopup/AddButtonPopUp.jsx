...
import styles from "./addButtonPopup.module.scss"

const AddButtonPopUp = ({items}) => {
    ...
    return (
      <div className={styles.addButtonOn}>
        <div className={styles.formOn}>
          ...
          <p>Created: <span className={styles.dateCreated}>{dateCreated}</span></p>
          <input type="text" placeholder="Attendees" className={styles.input}/>
          <input type="text" placeholder="Event Heading" className={styles.input}/>
          <input type="text" placeholder="Event" className={styles.input}/>
          <input type="text" placeholder="Category" className={styles.input}/>
          <input type="text" placeholder="Event Date" className={styles.input}/>
          <button className={styles.addBtn} onClick={() => createTask()}>Create Event</button>
        </div>
      </div>
    )

...
return (
    <div className={optionsOpen ? styles.calenderWithOptionsOpen : styles.calender}>
        <main>
        ...
        {daysInMonth.map((dim,index) => {
                return(
                    <div className={day == dim ? styles.selected_cell : styles.day_cell} key={index} onClick={(e) => handleChangeDay(e)}>
